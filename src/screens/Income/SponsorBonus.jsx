...
function SponsorBonus({ openSidebar }) {
    ...
    try {
      ...
      const settledResponses = await Promise.allSettled(
        contractInstances.map((c) =>
          c.methods
            .getTransactionLogByType(CurrentWalletAddress, "prtnerSponsorBonus")
            .call()
        )
      );
  ...
  return (
    ...
    >
      ...
      >
        <Title title="Partner Sponsor Bonus" />
        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="text-sm font-light text-center">
            Note: A minimum Self same rank or higher rank is required to unlock
